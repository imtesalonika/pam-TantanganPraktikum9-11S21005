...
class NotCompleteFragment : Fragment() {
...
//        view?.findViewById<LinearProgressIndicator>(R.id.progress_horizontal)?.visibility = View.VISIBLE
        val call = api.getLostFoundApi(token, 0, null, null)
        ...
        call.enqueue(object : Callback<GetAllLostAndFoundsResponse> {
            override fun onResponse(
                ...
                try {
                    val aksesDatabase = ViewModelProvider(this@NotCompleteFragment)[DataViewModel::class.java]
