...
class IsMeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_is_me, container, false)
    }
...
//        view?.findViewById<LinearProgressIndicator>(R.id.progress_horizontal)?.visibility = View.VISIBLE
        val call = api.getLostFoundApi(token, null, 1, null)
        ...
        call.enqueue(object : Callback<GetAllLostAndFoundsResponse> {
            override fun onResponse(
                ...
                try {
                    val aksesDatabase = ViewModelProvider(this@IsMeFragment)[DataViewModel::class.java]
